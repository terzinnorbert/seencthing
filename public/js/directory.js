...
/***/ "./resources/assets/js/directory.ts":
/*!******************************************!*\
  !*** ./resources/assets/js/directory.ts ***!
  \******************************************/
/*! no exports provided */
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _notify_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notify.ts */ "./resources/assets/js/notify.ts");


__webpack_require__(/*! ../../../node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js */ "./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js");
    ...
    if ('file' == $row.data('type')) {
        ...
        axios.post(downloadUrl).then((response) => {
            ...
            if (!response.data.success) {
                _notify_ts__WEBPACK_IMPORTED_MODULE_0__["default"].danger($row.find('.col-name').text() + '<hr>' + response.data.error);
                return;
            }
...
/***/ 1:
/*!************************************************!*\
  !*** multi ./resources/assets/js/directory.ts ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/resources/assets/js/directory.ts */"./resources/assets/js/directory.ts");
